...
/**
 * Creates the singleton {@link com.backlogtracker.backlogtracker.config.domain.AppConfig} document on
...
public class ConfigSeeder implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        log.info("App config ready (id={})",
                com.backlogtracker.backlogtracker.config.domain.AppConfig.SINGLETON_ID);
    }
}
