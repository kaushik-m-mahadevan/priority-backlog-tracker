...
public record NotificationView(String id, String type, String status, boolean actionable,
                               ...
                               String message, String linkPath) {
    ...
    public static NotificationView of(Notification n, String groupAppletKey) {
        return new NotificationView(n.getId(), n.getType().name(), n.getStatus().name(), n.isActionable(),
                n.getTitle(), n.getCreatedAt(), n.getGroupId(), n.getGroupName(), groupAppletKey, n.getInvitedByName(),
                n.getArchiveRequestId(), n.getItemId(), n.getItemTitle(), n.getMessage(), n.getLinkPath());
    }
}
