...
public record ImageMetaView(String id, int sequenceOrder, String uploadedByUserId, Instant uploadedAt) {

    public static ImageMetaView of(ImageAsset a) {
        return new ImageMetaView(a.getId(), a.getSequenceOrder(), a.getUploadedByUserId(), a.getUploadedAt());
    }
}
