...
public class CostConfigChangeController {
    ...
    @GetMapping
    public List<CostConfigChangeRequest> list(@PathVariable String groupId, @AuthenticationPrincipal AuthUser actor) {
    ...
    public CostConfigChangeRequest approve(@PathVariable String groupId, @PathVariable String requestId,
                                           @AuthenticationPrincipal AuthUser actor) {
        return service.approve(groupId, actor.id(), requestId);
    }

    @PostMapping("/{requestId}/reject")
    public CostConfigChangeRequest reject(@PathVariable String groupId, @PathVariable String requestId,
                                          @AuthenticationPrincipal AuthUser actor) {
